...
// Will glitch during a transition & overflow
//unsigned int calculateStep (unsigned int originalHue, unsigned int currentHue, unsigned int newHue, 
//                            unsigned int startTime, unsigned int totalTime) {
//                             
//                             
//} 
